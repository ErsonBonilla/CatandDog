...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        imagenMascota1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/CatandDog.jpeg"))); // NOI18N

        jButton2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/camara.png"))); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // Guardar la imagen de la mascota
    byte[] imagen = null;
    try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (respuesta == JFileChooser.APPROVE_OPTION) {
            ...
            imagenSeleccionada = new ImageIcon(ruta).getImage();  // Guardar la imagen seleccionada
    ...
    if (imagenBytes != null) {
        ...
        // Si no hay imagen, establecer una imagen predeterminada o vacía
...
private byte[] obtenerDatosImagen() throws IOException {
    if (imagenSeleccionada != null) {
        ...
        // Convertir el BufferedImage a un byte array
