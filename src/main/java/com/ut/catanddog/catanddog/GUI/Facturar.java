...
public class Facturar extends javax.swing.JFrame {
    ...
    public Facturar() {
        ...
        // Llamar al método para cargar el modelo de la tabla
        cargarTablaServicios();


         // Cargar los clientes en el JComboBox
        cargarClientesEnComboBox();
        //Desahabilito los txt 
    ...
    cmbCliente.addActionListener(new java.awt.event.ActionListener() {
        ...
        // Cargar los servicios en el JComboBox
    ...
    private void initComponents() {
        ...
        txtFecha1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btnCalcularCambio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/calcularCambio.png"))); // NOI18N
        ...
        btnRegistrarVenta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/registrarVenta.png"))); // NOI18N
...
// Obtener el nombre seleccionado en el JComboBox
    ...
    // Obtener el nombre del servicio seleccionado en el JComboBox
    ...
    // Incrementar el ID de factura y actualizar el campo de texto
    ...
    try {
        ...
        PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(filePath)); // Crear instancia de PdfWriter
        document.open();
        
        // Añadir el logo
        try {
            Image logo = Image.getInstance("C:\\Users\\User\\Documents\\Universidad del Tolima\\Aplicación POO\\CatandDog\\CatandDog\\src\\main\\resources\\imagenes\\CatandDog.jpeg"); // Reemplaza con la ruta a tu logo
        ...
        // Añadir el subtítulo de la sede principal
        ...
        // Crear una tabla con los detalles de la factura
...
// Obtener el nombre del servicio seleccionado del JComboBox
    String nombreServicio = (String) cmbServicio.getSelectedItem();

    // Obtener la cantidad ingresada en el JTextField
    String cantidadTexto = txtCantidad.getText().trim();

    // Verificar si se ha seleccionado un servicio y se ha ingresado una cantidad
    if (nombreServicio != null && !cantidadTexto.isEmpty()) {
        try {
            int cantidad = Integer.parseInt(cantidadTexto); // Convertir la cantidad a entero

            // Obtener el servicio de la base de datos utilizando el nombre del servicio
            ...
            if (servicio != null) {
                ...
                // Crear un nuevo objeto para agregar a la tabla
                Object[] fila = {
                    modeloTabla.getRowCount() + 1, // Num: incrementa según el número de filas
                    servicio.getNombre(),
                    cantidad,
                    precioUnitario,
                    subtotal,
                ...
                // Agregar la nueva fila a la tabla de servicios
    ...
    private void txtCantidadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCantidadActionPerformed
         // Obtener la cantidad unitaria ingresada por el usuario
    ...
    try {
        ...
        // Aquí puedes realizar cualquier acción con la cantidad ingresada, como guardarla en una variable o procesarla de alguna manera
    } catch (NumberFormatException e) {
        // Manejar el caso en que no se ingresó un valor válido
        System.err.println("Error: La cantidad ingresada no es un número válido.");
    }
...
// Limpiar el JComboBox
    ...
    // Obtener la lista de servicios desde tu Controladora
    ...
    // Agregar los servicios al JComboBox
    for (Servicio servicio : listaServicios) {
        cmbServicio.addItem(servicio.getNombre());
    }

    // Verificar si los servicios se han agregado correctamente
    if (cmbServicio.getItemCount() > 0) {
        System.out.println("Servicios cargados correctamente.");
    } else {
        System.out.println("No se pudieron cargar los servicios.");
    }
}

    private Servicio obtenerServicioPorNombre(String nombreServicio) {
        
    List<Servicio> listaServicios = control.traerListaServicios(); // Obtener la lista de servicios de la base de datos
    if (listaServicios != null) {
        for (Servicio servicio : listaServicios) {
            if (servicio.getNombre().equals(nombreServicio)) {
                return servicio; // Si se encuentra el servicio, devolverlo
            }
        }
    }
    return null; // Si no se encuentra ningún servicio con ese nombre, devolver null
}
...
// Definir modelo de la tabla
    DefaultTableModel modeloTabla = new DefaultTableModel() {
        ...
        public boolean isCellEditable(int row, int column) {
          // Hacer editable solo la columna de "Descuento" (índice 5) y "Acción" (índice 8)
            return column == 7;
        }
    };
    ...
    // Asignar renderer y editor de botón
    tablaServicios.getColumnModel().getColumn(7).setCellRenderer(new ButtonRenderer());
    tablaServicios.getColumnModel().getColumn(7).setCellEditor(new ButtonEditor(new JCheckBox(), tablaServicios));
}
...
DefaultTableModel modeloTabla = (DefaultTableModel) tablaServicios.getModel();
    ...
    for (int i = 0; i < modeloTabla.getRowCount(); i++) {
        BigDecimal subtotal = new BigDecimal((double) modeloTabla.getValueAt(i, 4)); // Subtotal column
        BigDecimal iva = new BigDecimal((double) modeloTabla.getValueAt(i, 5)); // IVA column
    ...
    // Mostrar los valores redondeados
...
class ButtonEditor extends DefaultCellEditor {
    ...
    protected void fireEditingStopped() {
        ...
        for (int i = 0; i < modeloTabla.getRowCount(); i++) {
            modeloTabla.setValueAt(i + 1, i, 0); // Actualizar el ID en la columna 0
        }
        }
    }
}
